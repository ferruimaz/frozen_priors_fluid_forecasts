# ============================================================
# Experiment C_ID — CIFAR-10 ID Experiments
...
def run_id_experiment():
    """
    Run ID experiments on CIFAR-10 data only.
    """
    print(f"Setting up CIFAR-10 ID Experiments...")
    ...
    # -------- Summary --------
    print("\n=== SUMMARY (q=%.2f) — ID (CIFAR-10) ===" % cfg.q)
    for nm in names:
        print(f"\n{nm}")
    ...
    out_path = f"expC_ID_clean_{ts}.json"
